...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-num-018-littlewood-conjecture-f196c963-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NUM-018"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-num-018-littlewood-conjecture-f196c963-v1",
      "problem_contract_sha256": "2521a6a37923ae27688a2fe4644181a0e80c94727bf0891b8fbc9de7691732e4",
      "problem_id": "problem:um-num-018-littlewood-conjecture-f196c963",
      "route_id": "route:um-num-018-littlewood-conjecture-f196c963-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-num-018-littlewood-conjecture-f196c963-source-fidelity-01",
      "graph_id": "graph:um-num-018-littlewood-conjecture-f196c963-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-num-018-littlewood-conjecture-f196c963-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-num-018-littlewood-conjecture-f196c963-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For any α,β ∈ ℝ, is lim inf_{n→∞} n·||nα||·||nβ|| = 0?"
          },
          "statement_sha256": "77d509b5d36ba1be0e94efd4c9929fc79c3eeb85781650b7569f24766964af44"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-num-018-littlewood-conjecture-f196c963-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-num-018-littlewood-conjecture-f196c963-root",
      "route_id": "route:um-num-018-littlewood-conjecture-f196c963-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-num-018-a89e77bef3d2",
        "url": "https://www.unsolvedmath.com/problems/NUM-018"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
